...
const courses = ref([
    ...
    },
    {
        id: 3,
        title: 'Angular',
        image: '/featurecatigories/angular.png',
        category: 'Framework',
        duration: '4 Weeks',
        students: 342,
        lessons: 45,
...
// ==========================================
// 4. COMPUTED PROPERTIES (Hisoblangan qiymatlar)
// ==========================================
...
/**
 * handleSearch - Search input o'zgarganida
 * Debounce bilan optimizatsiya qilingan
 */
...
/**
 * filterCourses - Category tanlanganda
 */
const filterCourses = () => {
...
/**
 * sortCourses - Sort tanlanganda
 */
const sortCourses = () => {
    console.log('Sorting by:', sortBy.value)
    ElMessage.success(`Sorted by ${sortBy.value}`)
}

/**
 * resetFilters - Barcha filterlarni tozalash
 */
const resetFilters = () => {
    searchQuery.value = ''
...
/**
 * toggleWishlist - Wishlist ga qo'shish/olib tashlash
 * @param {number} courseId - Kurs ID
 */
const toggleWishlist = (courseId) => {
    ...
    if (index > -1) {
        ...
        ElMessage.warning('Removed from wishlist')
    } else {
        // Qo'shish
...
/**
 * isInWishlist - Kurs wishlist da bormi tekshirish
 * @param {number} courseId - Kurs ID
 * @returns {boolean}
 */
...
/**
 * saveWishlist - Wishlist ni localStorage ga saqlash
 */
const saveWishlist = () => {
...
/**
 * loadWishlist - Wishlist ni localStorage dan yuklash
 */
const loadWishlist = () => {
...
/**
 * fetchCourses - Backend dan kurslarni yuklash
 * Haqiqiy loyihada API dan ma'lumot oladi
 */
const fetchCourses = async () => {
    loading.value = true

    try {
        // API call simulyatsiyasi
...
// ==========================================
// 6. WATCHERS (Kuzatuvchilar)
// ==========================================

/**
 * searchQuery ni kuzatish
 * Har safar o'zgarganida log qilish
 */
watch(searchQuery, (newValue, oldValue) => {
    console.log('Search changed:', { old: oldValue, new: newValue })
})

/**
 * filteredCourses ni kuzatish
 * Natijalar soni o'zgarganida xabar berish
 */
watch(filteredCourses, (newCourses) => {
    console.log('Filtered courses count:', newCourses.length)
})
...
/**
 * onMounted - Component yuklanganidan keyin
 */
onMounted(() => {
    ...
    // Agar backend bor bo'lsa, kurslarni yuklash
    // fetchCourses()
